...
public class LogInFrame extends javax.swing.JFrame {
    ...
    login.setUsername(usernametf.getText());   // Set the username from the input field
    login.setPassword(pwtf.getPassword());     // Set the password from the input field

    try {
        if (login.isAuthenticated()) { // Check authentication
            dispose(); // Close the login window
            MainFrame mainframe = new MainFrame(); // Instantiate the mainframe
